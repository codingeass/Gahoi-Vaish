<?php
    ...
    session_start();
    {
    $result=mysqli_query($mysql,"SELECT `email`,`image_location`,`Full Name`,city,state,country FROM userprofile WHERE `id` in (select friendID from friend_request where id=".$_SESSION["id"].") ");
